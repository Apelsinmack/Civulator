...
> **Last updated**: 2026-08-23 — v0.6.0 terrain remodel: layered tiles, mapgen package, new canonical rows below. Design record: `docs/terrain_model_design.md`; settings manual: `docs/worldgen_settings.md`.
